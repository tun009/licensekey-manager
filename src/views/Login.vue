...
import { Eye, EyeOff, Lock, Mail, ArrowRight, KeyRound } from 'lucide-vue-next'
...
const handleLogin = async (e: Event) => {
  ...
  try {
    ...
    if (success) {
      // Get redirect path from query or use default
...
const handleForgotPassword = async (e: Event) => {
  e.preventDefault()
  if (await authStore.forgotPassword(forgotEmail.value)) {
